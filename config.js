...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || https://i.imgur.com/1nK04AT.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'EXCEL BOT;EXCEL;0;https://i.imgur.com/uZy4heK.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,234',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,233',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,!',
    STICKER_DATA: process.env.STICKER_DATA || "EXCEL",
    BOT_NAME: process.env.BOT_NAME || 'EXCEL',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭EXCELꫂ;EXCEL MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
